...
inline int gamephaseInc[12] = {0,1,1,2,4,0,0,1,1,2,4,0};
...
const int mg_bishop_pair = 29;
const int eg_bishop_pair = 44;
...
struct Eval {
    ...
    static int eval(const chess::Board& board) {
        int mg[2];
        int eg[2];
        int gamePhase = 0;
